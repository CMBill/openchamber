...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.providers.page.custom.models.capabilities.title': '기능',
  'settings.providers.page.custom.models.capabilities.attachment.label': '첨부 파일',
  'settings.providers.page.custom.models.capabilities.attachment.info': '이 모델이 파일 첨부를 지원하는지 여부.',
  'settings.providers.page.custom.models.capabilities.attachment.unset': '설정 안 함',
  'settings.providers.page.custom.models.capabilities.attachment.enabled': '지원',
  'settings.providers.page.custom.models.capabilities.attachment.disabled': '지원하지 않음',
  'settings.providers.page.custom.models.capabilities.modalities.input.label': '입력 모달리티',
  'settings.providers.page.custom.models.capabilities.modalities.output.label': '출력 모달리티',
  'settings.providers.page.custom.models.capabilities.modalities.info': '이 모델이 지원하는 콘텐츠 유형을 선택하세요.',
  'settings.providers.page.custom.models.capabilities.limit.title': '토큰 제한',
  'settings.providers.page.custom.models.capabilities.limit.context': '컨텍스트',
  'settings.providers.page.custom.models.capabilities.limit.input': '입력',
  'settings.providers.page.custom.models.capabilities.limit.output': '출력',
  'settings.providers.page.custom.models.capabilities.variants.title': '변형',
  'settings.providers.page.custom.models.capabilities.variants.info': '이 모델이 지원하는 추론 강도를 선택하세요. 설정 파일에 직접 작성한 다른 변형은 보존됩니다.',
