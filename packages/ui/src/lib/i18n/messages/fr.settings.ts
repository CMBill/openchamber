...
export const settingsDict = {
  ...
  'settings.providers.page.custom.models.capabilities.title': 'Capacités',
  'settings.providers.page.custom.models.capabilities.attachment.label': 'Pièces jointes',
  'settings.providers.page.custom.models.capabilities.attachment.info': 'Indique si ce modèle accepte les pièces jointes.',
  'settings.providers.page.custom.models.capabilities.attachment.unset': 'Non défini',
  'settings.providers.page.custom.models.capabilities.attachment.enabled': 'Pris en charge',
  'settings.providers.page.custom.models.capabilities.attachment.disabled': 'Non pris en charge',
  'settings.providers.page.custom.models.capabilities.modalities.input.label': 'Modalités d’entrée',
  'settings.providers.page.custom.models.capabilities.modalities.output.label': 'Modalités de sortie',
  'settings.providers.page.custom.models.capabilities.modalities.info': 'Sélectionnez les types de contenu pris en charge par ce modèle.',
  'settings.providers.page.custom.models.capabilities.limit.title': 'Limites de jetons',
  'settings.providers.page.custom.models.capabilities.limit.context': 'Contexte',
  'settings.providers.page.custom.models.capabilities.limit.input': 'Entrée',
  'settings.providers.page.custom.models.capabilities.limit.output': 'Sortie',
  'settings.providers.page.custom.models.capabilities.variants.title': 'Variantes',
  'settings.providers.page.custom.models.capabilities.variants.info': 'Sélectionnez les niveaux de raisonnement pris en charge par ce modèle. Les variantes créées à la main dans la configuration sont conservées.',
