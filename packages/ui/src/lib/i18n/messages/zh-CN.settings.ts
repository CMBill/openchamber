...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.providers.page.custom.models.capabilities.title': '能力',
  'settings.providers.page.custom.models.capabilities.attachment.label': '附件',
  'settings.providers.page.custom.models.capabilities.attachment.info': '该模型是否接受文件附件。',
  'settings.providers.page.custom.models.capabilities.attachment.unset': '未设置',
  'settings.providers.page.custom.models.capabilities.attachment.enabled': '支持',
  'settings.providers.page.custom.models.capabilities.attachment.disabled': '不支持',
  'settings.providers.page.custom.models.capabilities.modalities.input.label': '输入模态',
  'settings.providers.page.custom.models.capabilities.modalities.output.label': '输出模态',
  'settings.providers.page.custom.models.capabilities.modalities.info': '选择该模型支持的内容类型。',
  'settings.providers.page.custom.models.capabilities.limit.title': 'Token 上限',
  'settings.providers.page.custom.models.capabilities.limit.context': '上下文',
  'settings.providers.page.custom.models.capabilities.limit.input': '输入',
  'settings.providers.page.custom.models.capabilities.limit.output': '输出',
  'settings.providers.page.custom.models.capabilities.variants.title': '变体',
  'settings.providers.page.custom.models.capabilities.variants.info': '选择该模型支持的推理强度。配置文件中手动编写的其他变体会被保留。',
