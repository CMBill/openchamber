...
export const settingsDict = {
  ...
  'settings.providers.page.custom.models.capabilities.title': 'Możliwości',
  'settings.providers.page.custom.models.capabilities.attachment.label': 'Załączniki',
  'settings.providers.page.custom.models.capabilities.attachment.info': 'Czy ten model akceptuje załączniki.',
  'settings.providers.page.custom.models.capabilities.attachment.unset': 'Nie ustawiono',
  'settings.providers.page.custom.models.capabilities.attachment.enabled': 'Obsługiwane',
  'settings.providers.page.custom.models.capabilities.attachment.disabled': 'Nieobsługiwane',
  'settings.providers.page.custom.models.capabilities.modalities.input.label': 'Modalności wejścia',
  'settings.providers.page.custom.models.capabilities.modalities.output.label': 'Modalności wyjścia',
  'settings.providers.page.custom.models.capabilities.modalities.info': 'Wybierz typy treści obsługiwane przez ten model.',
  'settings.providers.page.custom.models.capabilities.limit.title': 'Limity tokenów',
  'settings.providers.page.custom.models.capabilities.limit.context': 'Kontekst',
  'settings.providers.page.custom.models.capabilities.limit.input': 'Wejście',
  'settings.providers.page.custom.models.capabilities.limit.output': 'Wyjście',
  'settings.providers.page.custom.models.capabilities.variants.title': 'Warianty',
  'settings.providers.page.custom.models.capabilities.variants.info': 'Wybierz poziomy rozumowania obsługiwane przez ten model. Warianty dodane ręcznie w konfiguracji zostaną zachowane.',
